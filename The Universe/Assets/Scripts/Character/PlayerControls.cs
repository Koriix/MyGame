    ...
    ""maps"": [
        {
            ...
            ""id"": ""ef484f94-de6b-439f-9f20-8e8507eee3b9"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""PassThrough"",
                    ""id"": ""853adfd2-69ba-4cb8-9ec1-42e112a42ad5"",
                ...
                },
                {
                    ""name"": ""Camera"",
                    ""type"": ""PassThrough"",
                    ""id"": ""36f0b876-ba56-4305-80b0-d431cffab683"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""b29b4cf4-1c07-4992-b10e-90a030dd3c34"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""9bc6128a-ad12-491a-af6e-28dc84656266"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""b47d78b2-d534-495d-99b2-086e37cce60f"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""640f9c6c-f39d-4491-a988-0fbdc2448be0"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""7da4a0d0-367e-40b6-920b-2ce6107b897b"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""949f7861-77d8-428c-b526-bb1173cddeed"",
                ...
                {
                    ""name"": """",
                    ""id"": ""7f5b4bfe-706e-46a7-8569-03e5f9efc5a5"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
        ...
        {
            ""name"": ""Player Actions"",
            ""id"": ""b06d1541-cf4a-4235-9034-13bc0df5ae24"",
            ""actions"": [
                {
                    ""name"": ""Roll"",
                    ""type"": ""Button"",
                    ""id"": ""9abc34e8-d35f-46ab-9907-aee0f6a85bda"",
                ...
                },
                {
                    ""name"": ""RB"",
                    ""type"": ""Button"",
                    ""id"": ""d862b2ed-cdca-458e-a358-03ffcccb620d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""RT"",
                    ""type"": ""Button"",
                    ""id"": ""1d88751a-ef8a-4f0d-bc6c-73c5e7254bf6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""5b16fec1-fe45-49bb-b786-a1c39274ab96"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""PickUp"",
                    ""type"": ""Button"",
                    ""id"": ""b556beb6-5078-448b-a615-b00d5b7daf2f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Inventory"",
                    ""type"": ""Button"",
                    ""id"": ""5adeecb7-a7ff-4440-a715-724a0ddc1abc"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""0be47eb9-5f24-4c63-b858-2840f80e1fcf"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c6207d3f-1dfa-4c71-bcfc-a8ae3269911c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3dccd26e-c159-421f-a25e-d5544a49398e"",
                ...
                {
                    ""name"": """",
                    ""id"": ""46232630-586c-445d-89b8-d3778a082280"",
                ...
                {
                    ""name"": """",
                    ""id"": ""441b7523-e2e6-419f-8f66-1524afab06e6"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""2518649a-c527-48c3-b311-a8416853e8d8"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""b45cbb59-38ef-4520-a8ef-5508099f077d"",
                    ""path"": ""<Keyboard>/tab"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""id"": ""98b13b8e-ef60-4fec-b0bc-c62c253cbc8c"",
            ""actions"": [
                {
                    ""name"": ""D-Pad Up"",
                    ""type"": ""Button"",
                    ""id"": ""09b5b5c0-12fd-4c7d-aa4a-4515dc27382d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""D-Pad Down"",
                    ""type"": ""Button"",
                    ""id"": ""887fe984-2ee9-4392-a9e2-8f13eaad4885"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""D-Pad Left"",
                    ""type"": ""Button"",
                    ""id"": ""a09398bd-0817-4db3-a96c-29fea433bafe"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""D-Pad Right"",
                    ""type"": ""Button"",
                    ""id"": ""6c661141-3cd0-48b7-960d-76f7e09c0aa9"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""f020deed-6931-407a-9d13-6b9a7d457069"",
                ...
                {
                    ""name"": """",
                    ""id"": ""df4f1e57-d787-48f8-9de6-5b53824498f3"",
                ...
                {
                    ""name"": """",
                    ""id"": ""cd607cdf-26fb-4bca-8eeb-f543030b29a8"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c8541350-a7bb-4960-9ba7-9f660284ef23"",
